defmodule Garden do
  ...
  defp do_info([head | tail], [first | [second | upper_rest]], [third | [fourth | lower_rest]], result) do
    plants = [first, second, third, fourth]
  ...
  defp default_children, do: ~w<alice bob charlie david eve fred ginny harriet ileana joseph kincaid larry>a
